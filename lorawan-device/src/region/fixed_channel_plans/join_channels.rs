...
mod test {
    ...
    /// not from the device's configured data rate. This was broken when RX parameters were
    /// recalled from region state at RX time instead of being bound to the transmission.
    #[test]
